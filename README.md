...
Download the desired version for your operating system and processor architecture from the [k0sctl releases page](https://github.com/SquareFactory/cfctl/releases). Make the file executable and place it in a directory available in your `$PATH`.
