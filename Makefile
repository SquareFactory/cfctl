...
LD_FLAGS = -s -w -X github.com/SquareFactory/cfctl/version.Environment=$(ENVIRONMENT) -X github.com/SquareFactory/cfctl/version.GitCommit=$(GIT_COMMIT) -X github.com/SquareFactory/cfctl/version.Version=$(CFCTL_VERSION)
